  ...
  const copy = useMemo(() => {
      if (language === "hi") {
        return {
          ...
          description: "लाइव बैकएंड से एडमिशन, अपॉइंटमेंट, बिलिंग, वार्ड और स्टाफ गतिविधि पर नजर रखें।",
          today: "आज",
          month: "यह महीना",
          refresh: "वार्ड और बिलिंग हर 3 मिनट में रिफ्रेश",
          updated: "अंतिम अपडेट",
          ...
          departmentMixSub: "विभाग के अनुसार अपॉइंटमेंट वितरण",
          noDepartmentMix: "अभी विभाग डेटा नहीं है",
          noDepartmentMixDesc: "डॉक्टर और विभाग से अपॉइंटमेंट जुड़ने पर यह चार्ट दिखेगा।",
          weeklyOutcomes: "साप्ताहिक अपॉइंटमेंट परिणाम",
          weeklyOutcomesSub: "शेड्यूल्ड, पूर्ण और रद्द स्थिति",
          revenueTrend: "राजस्व ट्रेंड",
          last7Days: "पिछले 7 दिन",
          queue: "लाइव अपॉइंटमेंट कतार",
          ...
          bedMapSub: "मरीज जानकारी देखने के लिए बेड चुनें",
          registrations: "हाल के पंजीकरण",
          registrationsSub: "नवीनतम मरीज प्रोफाइल",
          surgeries: "आगामी सर्जरी",
          surgeriesSub: "आज की निर्धारित ओटी सूची",
          leaveRequests: "अवकाश अनुरोध",
          leaveRequestsSub: "डॉक्टर्स द्वारा भेजे गए नवीनतम अनुरोध",
          noLeaveRequests: "अभी कोई अवकाश अनुरोध नहीं है",
          noLeaveRequestsDesc: "अगला डॉक्टर अवकाश आवेदन यहां दिखाई देगा।",
          approve: "स्वीकृत करें",
          reject: "अस्वीकृत करें",
          pending: "लंबित",
          approved: "स्वीकृत",
          rejected: "अस्वीकृत",
          registerPatient: "नया मरीज जोड़ें",
          ...
          bedAvailableDesc: "इस बेड पर अभी कोई मरीज असाइन नहीं है।",
          name: "नाम",
          status: "स्थिति",
          city: "शहर",
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-6">
        ...
        <StatCard icon={HiOutlineUserGroup} label={copy.doctors} value={data?.stats.doctors.total ?? "-"} helper={`${data?.stats.doctors.active ?? 0} ${language === "hi" ? "सक्रिय" : "active"} / ${data?.stats.doctors.onLeave ?? 0} ${language === "hi" ? "अवकाश पर" : "on leave"}`} isLoading={isLoading} />
