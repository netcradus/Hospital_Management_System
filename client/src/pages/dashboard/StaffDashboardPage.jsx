  ...
  const copy = useMemo(() => {
    if (language === "hi") {
      return {
        ...
        description: "यह वर्कस्पेस मौजूदा स्टाफ प्रोफाइल के अनुसार बदलता है ताकि नर्स, रिसेप्शनिस्ट और फार्मासिस्ट का काम उसी बैकएंड डेटा के साथ चल सके।",
        ...
        appointmentsHelper: "मौजूदा शेड्यूल",
        pendingBilling: "लंबित बिलिंग",
        pendingHelper: "अनुवर्ती आवश्यक",
        staffRole: "स्टाफ भूमिका",
        staffRoleHelper: "स्टाफ रिकॉर्ड से प्राप्त",
        patientSearch: "मरीज खोज",
        patientSearchSub: "मौजूदा मरीजों में तुरंत खोज",
        searchPlaceholder: "मरीज का नाम खोजें",
        noPhone: "फोन उपलब्ध नहीं",
        noCity: "शहर उपलब्ध नहीं",
        roleWorkspace: "भूमिका वर्कस्पेस",
        roleWorkspaceSub: "स्टाफ भूमिका के अनुसार विजेट बदलते हैं",
        vitalsEntry: "वाइटल्स एंट्री",
        vitalsDesc: "चयनित मरीज वर्कफ़्लो से BP, pulse, temperature और SpO2 दर्ज करें।",
        vitalsBtn: "वाइटल्स फॉर्म खोलें",
        registration: "रजिस्ट्रेशन और चेक-इन",
        registrationDesc: "वॉक-इन, मल्टी-स्टेप रजिस्ट्रेशन और अपॉइंटमेंट समन्वय के लिए इस पैनल का उपयोग करें।",
        registrationBtn: "नया रजिस्ट्रेशन शुरू करें",
        pharmacy: "प्रिस्क्रिप्शन और इन्वेंटरी कतार",
        pharmacyDesc: "इन्वेंटरी के लिए बैकएंड एंडपॉइंट अभी नहीं हैं, इसलिए यह व्यू फिलहाल बिलिंग और मरीज रिकॉर्ड से जुड़ा है।",
        pharmacyBtn: "कतार से डिस्पेंस करें",
        generalTitle: "सामान्य स्टाफ वर्कस्पेस",
        generalDesc: "नर्स, रिसेप्शनिस्ट या फार्मासिस्ट जैसी अधिक विशिष्ट भूमिका असाइन करें ताकि अनुकूलित डैशबोर्ड दिख सके।",
        dailyList: "दैनिक अपॉइंटमेंट सूची",
        dailyListSub: "चेक-इन और समन्वय के लिए उपयोग करें",
        supportAlerts: "सपोर्ट अलर्ट",
        supportAlertsSub: "मौजूदा रिकॉर्ड से निकले ऑपरेशनल रिमाइंडर",
        pendingCollections: "लंबित कलेक्शन",
        pendingCollectionsDesc: "इनवॉइस फॉलो-अप की आवश्यकता है।",
        newRegistrations: "नए रजिस्ट्रेशन",
        newRegistrationsDesc: "हाल की मरीज प्रोफाइल सत्यापन के लिए तैयार हैं।",
        medicationSupport: "मेडिकेशन सपोर्ट",
        medicationSupportDesc: "फुल स्टॉक विजेट्स के लिए फार्मेसी-विशिष्ट बैकएंड एंडपॉइंट्स अभी आवश्यक हैं।",
      };
    }

    const raw =
      language === "__disabled_hi__"
      ? {
          eyebrow: "????? ???????",
          title: `${data?.staffProfile?.role || "?????? ???"} ????????`,
          description: "?? ????????? ?????? ????? ???????? ?? ?????? ????? ?? ???? ????, ???????? ?? ???????? ????? ?? ?? ?????? API ?? ??? ?? ?????",
          refresh: "???? ??????? ?? 3 ????",
          updated: "????? ?????",
          assignedPatients: "????? ????",
          ...
          roleWorkspaceSub: "????? ?????? ?? ?????? ????? ????? ???",
          vitalsEntry: "??????? ??????",
          vitalsDesc: "????? ???? ?? ??? BP, pulse, temperature ?? SpO2 ??????? ?????",
          vitalsBtn: "??????? ????? ?????",
          registration: "??????????? ?? ???-??",
          registrationDesc: "???-??, ?????-????? ??????????? ?? ?????????? ??????????? ?? ??? ?? ???? ?? ????? ?????",
          registrationBtn: "?? ??????????? ???? ????",
          ...
          supportAlertsSub: "?????? ??????? ?? ??????? ????????",
          pendingCollections: "????? ???????",
          pendingCollectionsDesc: "?????? ?? ????-?? ?????? ???",
          newRegistrations: "?? ???????????",
          newRegistrationsDesc: "??? ?? ???? ???????? ??????? ?? ??? ????? ????",
          medicationSupport: "???????? ??????",
